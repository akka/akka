...
- [help wanted](https://github.com/akka/akka/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) - which identifies issues that the core team will likely not have time to work on, or the issue is a nice entry level ticket. If you're not sure how to solve a ticket but would like to work on it feel free to ask in the issue about clarification or tips.
