...
It is possible to switch to a new version of serializer for a message in @ref:[two rolling upgrade steps](additional/schema-evolution.md#serializer-evolution-without-downtime)
