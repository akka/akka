...
The @scala[akka.cluster.ddata.typed.scaladsl.Replicator]@java[akka.cluster.ddata.typed.javadsl.Replicator] 
actor provides the API for interacting with the data and is accessed through the extension 
@scala[akka.cluster.ddata.typed.scaladsl.DistributedData]@java[akka.cluster.ddata.typed.javadsl.DistributedData].
