...
As an "alternative to the alternative", an `EntityRef` can be included in the messages.  The `EntityRef` transparently wraps messages in a `ShardingEnvelope` and 
