...
This can be used, for example, to match up Kafka Partition consumption with shard locations. The video [How to co-locate Kafka Partitions with Akka Cluster Shards](How to co-locate Kafka Partitions with Akka Cluster Shards)[https://akka.io/blog/news/2020/03/18/akka-sharding-kafka-video] explains a setup for it. Alpakka Kafka provides [an extension for Akka Cluster Sharding](https://doc.akka.io/docs/alpakka-kafka/current/cluster-sharding.html).
