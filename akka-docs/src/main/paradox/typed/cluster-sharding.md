...
The @scala[`entityId`, `entityName`, and (in multi-DC use-cases) `dataCenter` of an `EntityRef`]@java[`getEntityId`, `getEntityName`, and (in multi-DC use-cases) `getDataCenter` methods of an `EntityRef`]
