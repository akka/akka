 ...
 * @extref[Microservices with Akka tutorial](platform-guide:microservices-tutorial/index.html) illustrates how to implement an Event Sourced CQRS application with Akka Persistence and Akka Projections 
