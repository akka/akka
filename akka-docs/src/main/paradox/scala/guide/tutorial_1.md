...
The family of these lifecycle hooks is rich, and we recommend reading @ref:[the actor lifecycle](actors.html#actor-lifecycle) section of the reference for all details.
