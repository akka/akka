...
Cluster client has been deprecated in favor of [Akka gRPC](https://doc.akka.io/docs/akka-grpc/current/index.html).
(FIXME https://github.com/akka/akka/issues/26175)
