...
|Source|<a name="fromcompletionstage"></a>@ref[fromCompletionStage](Source/fromCompletionStage.md)|Deprecated by @ref[`Source.completionStage`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcefromCompletionStage.mdcompletionStage.md).|
|Source|<a name="fromfuture"></a>@ref[fromFuture](Source/fromFuture.md)|Deprecated by @ref[`Source.future`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcefromFuture.mdfuture.md).|
|Source|<a name="fromfuturesource"></a>@ref[fromFutureSource](Source/fromFutureSource.md)|Deprecated by @ref[`Source.futureSource`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcefromFutureSource.mdfutureSource.md).|
...
|Source|<a name="fromsourcecompletionstage"></a>@ref[fromSourceCompletionStage](Source/fromSourceCompletionStage.md)|Deprecated by @ref[`Source.completionStageSource`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcefromSourceCompletionStage.mdcompletionStageSource.md).|
...
|Source|<a name="lazily"></a>@ref[lazily](Source/lazily.md)|Deprecated by @ref[`Source.lazySource`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcelazily.mdlazySource.md).|
|Source|<a name="lazilyasync"></a>@ref[lazilyAsync](Source/lazilyAsync.md)|Deprecated by @ref[`Source.lazyFutureSource`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSourcelazilyAsync.mdlazyFutureSource.md).|
...
|Sink|<a name="collection"></a>@ref[collection](Sink/collection.md)|@scala[Collect all values emitted from the stream into a collection.]@java[Operator only available in the Scala API. The closest operator in the Java API is @ref[`Sink.seq`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSinkcollection.mdseq.md)].|
...
|Sink|<a name="lazyinitasync"></a>@ref[lazyInitAsync](Sink/lazyInitAsync.md)|Deprecated by @ref[`Sink.lazyFutureSink`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSinklazyInitAsync.mdlazyFutureSink.md).|
...
|Flow|<a name="lazyinitasync"></a>@ref[lazyInitAsync](Flow/lazyInitAsync.md)|Deprecated by @ref[`Flow.lazyFutureFlow`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsFlowlazyInitAsync.mdlazyFutureFlow.md) in combination with @ref[`prefixAndTail`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsFlowlazyInitAsync.md../Source-or-Flow/prefixAndTail.md).|
...
|Source/Flow|<a name="scanasync"></a>@ref[scanAsync](Source-or-Flow/scanAsync.md)|Just like @ref[`scan`](C:UsersDomantasIdeaProjectsakkaakka-docssrcmainparadoxstreamoperatorsSource-or-FlowscanAsync.md./scan.md) but receives a function that results in a @scala[`Future`] @java[`CompletionStage`] to the next value.|
