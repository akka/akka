    ...
    new TestKit(system) {
      {
        ...
        CompletableFuture<Object> future1 = ask(actorA, "request", 1000).toCompletableFuture();
  ...
  public void coordinatedShutdown() {
    ...
    CoordinatedShutdown.get(system)
        .addTask(
            ...
            "someTaskName",
            () -> {
              return akka.pattern.PatternsCS.ask(
                      someActor, "stop", new Timeout(5, TimeUnit.SECONDS))
