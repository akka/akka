...
package docs.serialization {
  ...
  class SerializationDocSpec extends AkkaSpec {
    ...
    "demonstrate configuration of serialization-bindings" in {
      ...
      """)
      val a = ActorSystem("system", config)
      SerializationExtension(a).serializerFor(classOf[String]).getClass should be(classOf[TestMessageSerializer])
      SerializationExtension(a).serializerFor(classOf[Customer]).getClass should be(classOf[TestMessageSerializer])
