...
in the :ref:`exception-handling-scala` section of the documentation. You can use them to transform exceptions into
:class:`HttpResponse` s with appropriate error codes and human-readable failure descriptions.
