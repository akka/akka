...
The TCK is usable from Java as well as Scala projects, for Scala you need to include the akka-persistence-experimental-tck dependency::

  "com.typesafe.akka" %% "akka-persistence-experimental-tck" % "@version@" % "test"
