...
.. code-block:: none
   ...
   cd target/universal/
   unzip akka-sample-main-scala-2.4-M1.zip
   chmod u+x akka-sample-main-scala-2.4-M1/bin/akka-sample-main-scala
   akka-sample-main-scala-2.4-M1/bin/akka-sample-main-scala sample.hello.Main
