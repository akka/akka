...
.. code-block:: none
   ...
   cd target/universal/
   unzip akka-sample-main-scala-2.4.9-RC2.zip
   chmod u+x akka-sample-main-scala-2.4.9-RC2/bin/akka-sample-main-scala
   akka-sample-main-scala-2.4.9-RC2/bin/akka-sample-main-scala sample.hello.Main
