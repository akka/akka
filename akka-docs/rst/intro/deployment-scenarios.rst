...
.. code-block:: none
   ...
   cd target/universal/
   unzip akka-sample-main-scala-2.4-ARTERY-M3.zip
   chmod u+x akka-sample-main-scala-2.4-ARTERY-M3/bin/akka-sample-main-scala
   akka-sample-main-scala-2.4-ARTERY-M3/bin/akka-sample-main-scala sample.hello.Main
