...
.. includecode:: code/docs/actor/MyJavaActor.java
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-props
.. includecode:: code/docs/actor/ActorDocTest.java#creating-props
...
.. includecode:: code/docs/actor/ActorDocTest.java#creating-props-deprecated
...
.. includecode:: code/docs/actor/ActorDocTest.java#props-factory
...
.. includecode:: code/docs/actor/ActorDocTest.java#messages-in-companion
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-actorRef
.. includecode:: code/docs/actor/ActorDocTest.java#system-actorOf
...
.. includecode:: code/docs/actor/ActorDocTest.java#context-actorOf
...
.. includecode:: code/docs/actor/DependencyInjectionDocTest.java#import
.. includecode:: code/docs/actor/DependencyInjectionDocTest.java
...
.. includecode:: code/docs/actor/ActorDocTest.java#lifecycle-callbacks
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-terminated
.. includecode:: code/docs/actor/ActorDocTest.java#watch
...
.. includecode:: code/docs/actor/ActorDocTest.java#preStart
...
.. includecode:: code/docs/actor/ActorDocTest.java#selection-local
...
.. includecode:: code/docs/actor/ActorDocTest.java#selection-wildcard
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-identify
.. includecode:: code/docs/actor/ActorDocTest.java#identify
...
.. includecode:: code/docs/actor/ActorDocTest.java#selection-remote
...
.. includecode:: code/docs/actor/ActorDocTest.java#tell
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-ask
.. includecode:: code/docs/actor/ActorDocTest.java#ask-pipe
...
.. includecode:: code/docs/actor/ActorDocTest.java#reply-exception
...
.. includecode:: code/docs/actor/ActorDocTest.java#forward
...
.. includecode:: code/docs/actor/ActorDocTest.java#createReceive
...
.. includecode:: code/docs/actor/GraduallyBuiltActor.java
...
.. includecode:: code/docs/actor/ActorDocTest.java#well-structured
...
.. includecode:: code/docs/actor/ActorDocTest.java#optimized
...
.. includecode:: code/docs/actor/MyJavaActor.java#reply
...
.. includecode:: code/docs/actor/ActorDocTest.java#receive-timeout
...
.. includecode:: code/docs/actor/ActorDocTest.java#postStop
...
.. includecode:: code/docs/actor/ActorDocTest.java#poison-pill
...
.. includecode:: code/docs/actor/ActorDocTest.java#import-gracefulStop

.. includecode:: code/docs/actor/ActorDocTest.java#gracefulStop

.. includecode:: code/docs/actor/ActorDocTest.java#gracefulStop-actor
...
.. includecode:: code/docs/actor/ActorDocTest.java#coordinated-shutdown-addTask
...
.. includecode:: code/docs/actor/ActorDocTest.java#coordinated-shutdown-run
...
.. includecode:: code/docs/actor/ActorDocTest.java#coordinated-shutdown-jvm-hook
...
.. includecode:: code/docs/actor/ActorDocTest.java#hot-swap-actor
...
.. includecode:: code/docs/actor/ActorDocTest.java#swapper
...
.. includecode:: code/docs/actor/ActorDocTest.java#stash
...
.. includecode:: code/docs/actor/ActorDocTest.java#kill
...
.. includecode:: code/docs/actor/InitializationDocTest.java#preStartInit
...
.. includecode:: code/docs/actor/InitializationDocTest.java#messageInit
