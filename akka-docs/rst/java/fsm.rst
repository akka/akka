...
.. includecode:: code/docs/actor/fsm/Buncher.java#simple-imports

The contract of our “Buncher” actor is that it accepts or produces the following messages:

.. includecode:: code/docs/actor/fsm/Events.java
...
.. includecode:: code/docs/actor/fsm/Buncher.java
...
.. includecode:: code/docs/actor/fsm/Buncher.java#unhandled-elided
...
.. includecode:: code/docs/actor/fsm/Buncher.java#transition-elided
...
.. includecode:: code/docs/actor/fsm/BuncherTest.java
   :include: test-code
...
.. includecode:: code/docs/actor/fsm/FSMDocTest.java#NullFunction
...
.. includecode:: code/docs/actor/fsm/FSMDocTest.java
