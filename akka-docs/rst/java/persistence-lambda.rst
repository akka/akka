...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#definition
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#usage
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#recover-on-start-disabled

In this case, a processor must be recovered explicitly by sending it a ``Recover`` message.

.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#recover-explicit
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#recover-on-start-custom
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#recover-on-restart-disabled
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#deletion
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#processor-id
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#processor-id-override
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#channel-example
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#channel-example-reply
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#channel-custom-settings
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#channel-custom-listener
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#persistent-channel-example
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#persistent-channel-watermarks
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#persistent-channel-reply
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#channel-id-override
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#current-message
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#reliable-event-delivery
...
.. includecode:: code/docs/persistence/LambdaPersistenceDocTest.java#batch-write
