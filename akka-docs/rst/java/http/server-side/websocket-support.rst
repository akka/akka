...
.. _example: @github@/akka-docs/rst/java/code/docs/http/javadsl/server/WebSocketRoutingExample.java
.. _full routing example: @github@/akka-docs/rst/java/code/docs/http/javadsl/server/WebSocketRoutingExample.java
