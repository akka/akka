...
<<<<<<< Updated upstream
- [ ] Check the release on https://repo.akka.io/maven/com/typesafe/akka/akka-actor_2.13/$VERSION$/
=======
- [ ] Check the release on [Akka's repository](https://repo.akka.io/maven/com/typesafe/akka/akka-actor_2.13/$VERSION$/akka-actor_2.13-$VERSION$)
>>>>>>> Stashed changes
