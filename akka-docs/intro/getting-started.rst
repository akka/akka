...
- ``akka-slf4j-1.1.3-SNAPSHOT.jar`` -- SLF4J Event Handler Listener
...
2) Add the Akka dependencies. For example, here is the dependency for Akka Actor 1.1.3-SNAPSHOT:
...
The Scala version in your SBT project needs to match the version that Akka is built against. For Akka 1.1.3-SNAPSHOT this is
...
*Note: the plugin version matches the Akka version provided. The current release is 1.1.3-SNAPSHOT.*
