...
.. _Dining Hakkers: http://github.com/akka/akka/tree/v2.0.3/akka-samples/akka-sample-fsm/src/main/scala/DiningHakkersOnBecome.scala
...
See this `Unnested receive example <http://github.com/akka/akka/tree/v2.0.3/akka-docs/scala/code/akka/docs/actor/UnnestedReceives.scala>`_.
