...
`ScatterGatherFirstCompletedRouter <http://github.com/akka/akka/tree/v2.0.3/akka-actor/src/main/scala/akka/routing/Routing.scala#L375>`_
...
`RoutingSpec <http://github.com/akka/akka/tree/v2.0.3/akka-actor-tests/src/test/scala/akka/routing/RoutingSpec.scala>`_
