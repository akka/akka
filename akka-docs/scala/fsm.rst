 ...
 * `Dining Hakkers using FSM <http://github.com/akka/akka/tree/v2.0.4/akka-samples/akka-sample-fsm/src/main/scala/DiningHakkersOnFsm.scala#L1>`_
 * `Dining Hakkers using become <http://github.com/akka/akka/tree/v2.0.4/akka-samples/akka-sample-fsm/src/main/scala/DiningHakkersOnBecome.scala#L1>`_
