...
object Dependencies {
  ...
  object Compile {
    ...
    object TestDependencies {
      ...
      val metrics = "io.dropwizard.metrics" % "metrics-core" % "4.2.9" % Test // ApacheV2
      val metricsJvm = "io.dropwizard.metrics" % "metrics-jvm" % "4.2.9" % Test // ApacheV2
      ...
      val reactiveStreamsTck = "org.reactivestreams" % "reactive-streams-tck" % reactiveStreamsVersion % Test // MIT-0
