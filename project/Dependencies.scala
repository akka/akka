...
object Dependencies {
  ...
  object TestDependencies {
    ...
    val metrics = "io.dropwizard.metrics" % "metrics-core" % "4.2.26" % Test // ApacheV2
    val metricsJvm = "io.dropwizard.metrics" % "metrics-jvm" % "4.2.26" % Test // ApacheV2
  ...
  object Provided {
    ...
    val classgraph = "io.github.classgraph" % "classgraph" % "4.8.174" % "optional;provided;test" // MIT
