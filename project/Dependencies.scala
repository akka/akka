...
object Dependencies {
  ...
  object Compile {
    ...
    object TestDependencies {
      ...
      val commonsIo = "commons-io" % "commons-io" % "2.14.0" % Test // ApacheV2
      ...
      val metrics = "io.dropwizard.metrics" % "metrics-core" % "4.2.20" % Test // ApacheV2
      val metricsJvm = "io.dropwizard.metrics" % "metrics-jvm" % "4.2.20" % Test // ApacheV2
