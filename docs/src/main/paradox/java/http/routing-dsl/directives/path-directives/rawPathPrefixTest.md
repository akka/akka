...
As opposed to its @ref[pathPrefixTest-java](pathPrefixTest.md#pathprefixtest-java) counterpart `rawPathPrefixTest` does *not* automatically add a leading slash
