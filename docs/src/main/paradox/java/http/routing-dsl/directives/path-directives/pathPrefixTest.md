...
This directive is very similar to the @ref[pathPrefix-java](pathPrefix.md#pathprefix-java) directive with the one difference that the path prefix
...
As opposed to its @ref[rawPathPrefixTest-java](rawPathPrefixTest.md#rawpathprefixtest-java) counterpart `pathPrefixTest` automatically adds a leading slash to its
