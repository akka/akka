...
potentially existing `rawPathPrefix` or @ref[pathPrefix-java](pathPrefix.md#pathprefix-java) directives on higher levels of the routing structure.
...
As opposed to its @ref[pathPrefix-java](pathPrefix.md#pathprefix-java) counterpart `rawPathPrefix` does *not* automatically add a leading slash to its
