...
See also @ref[authenticateOAuth2PF](authenticateOAuth2PF.md#authenticateoauth2pf-java) if the authorization operation is rather quick, and does not have to execute asynchronously.
...
Usage in code is exactly the same as @ref[authenticateBasicPFAsync](authenticateBasicPFAsync.md#authenticatebasicpfasync-java),
