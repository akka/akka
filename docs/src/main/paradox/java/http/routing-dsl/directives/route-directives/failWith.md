...
structure's @ref[Exception Handling](../../exception-handling.md#exception-handling-java) mechanism to deal with the exception even if the current route is executed
...
`HttpResponse` using the in-scope `ExceptionHandler` (see also the @ref[Exception Handling](../../exception-handling.md#exception-handling-java) chapter).
