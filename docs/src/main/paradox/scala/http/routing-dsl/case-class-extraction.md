...
The value extraction performed by @ref[Directives](directives/index.md#directives) is a nice way of providing your route logic with interesting request
...
You could get this done with a few @ref[validate](directives/misc-directives/validate.md#validate) directives but this would quickly become cumbersome and hard to
read.
