...
object StreamRefSettings {
  ...
  /** Java API */
  @deprecated(
    "Use attributes on the Runnable graph or change the defaults in configuration, see migration guide for details https://doc.akka.io/docs/akka/current/project/migration-guide-2.5.x-2.6.x.html",
    since = "2.6.0")
