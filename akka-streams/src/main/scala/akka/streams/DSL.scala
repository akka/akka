...
object DSL {
  case class ProcessedProducer[I, O](producer: Producer[I], operation: Operation[I, O]) {
    ...
    def andThen[O2](next: Operation[O, O2]): ProcessedProducer[I, O2] = ProcessedProducer(producer, operation.andThen(next))
  }
  ...
  trait Ops[I0, I] extends Any {
    ...
    def foldUntil[Z, O2](seed: Z)(acc: (Z, I) ⇒ FoldResult[Z, O2]): ProcessedProducer[I0, O2] = andThen(FoldUntil(seed, acc))
