 ...
 */
private[akka] final case class Hello(name: String, address: Address) extends NetworkOp
...
private[akka] final case class AddressReply(node: RoleName, address: Address) extends UnconfirmedClientOp with NetworkOp
