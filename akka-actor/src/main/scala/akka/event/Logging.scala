...
import akka.util.{ Helpers, ReentrantGuard, StringFormatter }
...
trait LoggingAdapter {
   ...
   * there are more than four arguments.
   */
  private def format1(t: String, arg: Any): String = StringFormatter.formatArray(t, arg)

  def format(t: String, arg: Any*): String = StringFormatter.format(t, arg: _*)
}
