...
To try this example locally, download the sources files with [akka-sample-sharding-scala.zip](https://doc.akka.io/docs/akka/snapshot/attachments/akka-sample-sharding-scala.zip).
