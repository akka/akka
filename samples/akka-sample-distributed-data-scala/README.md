...
To try this example locally, download the sources files with [akka-sample-distributed-data-scala.zip](https://doc.akka.io/libraries/akka-core/current//attachments/akka-sample-distributed-data-scala.zip).
