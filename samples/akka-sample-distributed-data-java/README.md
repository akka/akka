...
To try this example locally, download the sources files with [akka-sample-distributed-data-java.zip](https://doc.akka.io/docs/akka/snapshot/attachments/akka-sample-distributed-data-java.zip).
