...
class ChainSetup[In, Out](
  ...
  def this(stream: Flow[In, In, _] ⇒ Flow[In, Out, _], settings: ActorFlowMaterializerSettings, toPublisher: (Source[Out, _], ActorMaterializer) ⇒ Publisher[Out])(implicit system: ActorSystem) =
  ...
  def this(stream: Flow[In, In, _] ⇒ Flow[In, Out, _],
           ...
           materializerCreator: (ActorFlowMaterializerSettings, ActorRefFactory) ⇒ ActorMaterializer,
