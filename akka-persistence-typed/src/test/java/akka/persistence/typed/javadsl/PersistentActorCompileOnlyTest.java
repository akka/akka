...
public class PersistentActorCompileOnlyTest {
  ...
  public abstract static class Simple {
    ...
    public static PersistentBehavior<SimpleCommand, SimpleEvent, SimpleState> pb =
        new PersistentBehavior<SimpleCommand, SimpleEvent, SimpleState>("p1") {
          @Override
  ...
  abstract static class WithAck {
    ...
    private PersistentBehavior<MyCommand, MyEvent, ExampleState> pa =
        new PersistentBehavior<MyCommand, MyEvent, ExampleState>("pa") {
          @Override
  ...
  abstract static class RecoveryComplete {
    ...
    class MyPersistentBehavior
        extends PersistentBehavior<Command, Event, RecoveryComplete.EventsInFlight> {
