 ...
 * 'emptyState' is null
 */
public class AccountExampleNoBuildersWithNull extends EventSourcedBehavior<AccountExampleNoBuildersWithNull.AccountCommand, AccountExampleNoBuildersWithNull.AccountEvent, AccountExampleNoBuildersWithNull.Account> {

    public AccountExampleNoBuildersWithNull(String accountNumber) {
    ...
    public CommandHandler<AccountCommand, AccountEvent, Account> commandHandler() {
        return (account, accountCommand) -> {
            if (account == null)
                return firstCommand(accountCommand);
            else
                return account.applyCommand(accountCommand);
        };
    }

    @Override
    public EventHandler<Account, AccountEvent> eventHandler() {
        return (account, accountEvent) -> {
            if (account == null)
                return firstEvent(accountEvent);
            else
                return account.applyEvent(accountEvent);
        };
    }
    ...
    public Effect<AccountEvent, Account> firstCommand(AccountCommand cmd) {
    ...
    public Account firstEvent(AccountEvent event) {
