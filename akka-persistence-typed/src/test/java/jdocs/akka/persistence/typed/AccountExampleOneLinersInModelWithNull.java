...
public class AccountExampleOneLinersInModelWithNull extends EventSourcedBehavior<AccountExampleOneLinersInModelWithNull.AccountCommand, AccountExampleOneLinersInModelWithNull.AccountEvent, AccountExampleOneLinersInModelWithNull.Account> {
    ...
    public static Behavior<AccountCommand> behavior(String accountNumber) {
        return Behaviors.setup(context -> new AccountExampleOneLinersInModelWithNull(context, accountNumber));
    }

    public AccountExampleOneLinersInModelWithNull(ActorContext<AccountCommand> context, String accountNumber) {
