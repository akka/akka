...
public final class ReplicatedEventSourcing {
  ...
  public interface EventConsumedOrBuilder
      extends
      // @@protoc_insertion_point(interface_extends:EventConsumed)
      akka.protobufv3.internal.MessageOrBuilder {

    /**
     * <code>required string persistenceId = 1;</code>
     *
     * @return Whether the persistenceId field is set.
     */
    boolean hasPersistenceId();
  ...
  /** Protobuf type {@code EventConsumed} */
  public static final class EventConsumed extends akka.protobufv3.internal.GeneratedMessageV3
      implements
      // @@protoc_insertion_point(message_implements:EventConsumed)
      EventConsumedOrBuilder {
    private static final long serialVersionUID = 0L;
    // Use EventConsumed.newBuilder() to construct.
    private EventConsumed(akka.protobufv3.internal.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final akka.protobufv3.internal.Descriptors.Descriptor getDescriptor() {
      return akka.persistence.typed.serialization.ReplicatedEventSourcing
          .internal_static_EventConsumed_descriptor;
    }
    ...
    protected akka.protobufv3.internal.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return akka.persistence.typed.serialization.ReplicatedEventSourcing
          .internal_static_EventConsumed_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed.class,
              akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed.Builder
                  .class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj
          instanceof akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed)) {
        return super.equals(obj);
      }
      akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed other =
          (akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed) obj;
    ...
    public static akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
        parseFrom(java.nio.ByteBuffer data)
            throws akka.protobufv3.internal.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Builder newBuilder(
        akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder
        extends akka.protobufv3.internal.GeneratedMessageV3.Builder<Builder>
        implements
        // @@protoc_insertion_point(builder_implements:EventConsumed)
        akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumedOrBuilder {
      public static final akka.protobufv3.internal.Descriptors.Descriptor getDescriptor() {
        return akka.persistence.typed.serialization.ReplicatedEventSourcing
            .internal_static_EventConsumed_descriptor;
      }
      ...
      // Construct using
      // akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
          getDefaultInstanceForType() {
        return akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
            .getDefaultInstance();
      }

      @java.lang.Override
      public akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed build() {
        akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      public akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
          buildPartial() {
        akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed result =
            new akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed other) {
        if (other
            == akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
                .getDefaultInstance()) return this;
        if (other.hasPersistenceId()) {
          bitField0_ |= 0x00000001;
          persistenceId_ = other.persistenceId_;
      ...
      public Builder mergeFrom(
          ...
          akka.protobufv3.internal.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed parsedMessage =
            null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (akka.protobufv3.internal.InvalidProtocolBufferException e) {
      ...
      // @@protoc_insertion_point(builder_scope:EventConsumed)
    }

    // @@protoc_insertion_point(class_scope:EventConsumed)
    private static final akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE =
          new akka.persistence.typed.serialization.ReplicatedEventSourcing.EventConsumed();
    }
    ...
    @java.lang.Deprecated
    public static final akka.protobufv3.internal.Parser<EventConsumed> PARSER =
        new akka.protobufv3.internal.AbstractParser<EventConsumed>() {
          @java.lang.Override
          public EventConsumed parsePartialFrom(
              akka.protobufv3.internal.CodedInputStream input,
              akka.protobufv3.internal.ExtensionRegistryLite extensionRegistry)
              throws akka.protobufv3.internal.InvalidProtocolBufferException {
            return new EventConsumed(input, extensionRegistry);
          }
        };

    public static akka.protobufv3.internal.Parser<EventConsumed> parser() {
      return PARSER;
    }

    @java.lang.Override
    public akka.protobufv3.internal.Parser<EventConsumed> getParserForType() {
      return PARSER;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\035ReplicatedEventSourcing.proto\032\026Contain"
          ...
          + "EventConsumed\022\025\n\rpersistenceId\030\001 \002(\t\022\022\n\n"
          + "sequenceNr\030\002 \002(\003*-\n\014ORSetDeltaOp\022\007\n\003Add\020"
          + "\000\022\n\n\006Remove\020\001\022\010\n\004Full\020\002B(\n$akka.persiste"
          + "nce.typed.serializationH\001"
    };
    descriptor =
    ...
    internal_static_EventConsumed_descriptor = getDescriptor().getMessageTypes().get(9);
    internal_static_EventConsumed_fieldAccessorTable =
        new akka.protobufv3.internal.GeneratedMessageV3.FieldAccessorTable(
            internal_static_EventConsumed_descriptor,
            new java.lang.String[] {
