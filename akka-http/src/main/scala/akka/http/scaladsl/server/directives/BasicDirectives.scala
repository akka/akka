...
trait BasicDirectives {
   ...
   */
  def withFlowMaterializer(materializer: Materializer): Directive0 =
    mapRequestContext(_ withFlowMaterializer materializer)

  /**
   * Extracts the [[Materializer]] from the [[RequestContext]].
   */
  def extractFlowMaterializer: Directive1[Materializer] = BasicDirectives._extractFlowMaterializer
...
object BasicDirectives extends BasicDirectives {
  ...
  private val _extractFlowMaterializer: Directive1[Materializer] = extract(_.flowMaterializer)
