 ...
 *   $ javac -cp dist/akka-actor-1.1-RC1.jar:scala-library.jar akka/tutorial/first/java/Pi.java
 *   $ java -cp dist/akka-actor-1.1-RC1.jar:scala-library.jar:. akka.tutorial.first.java.Pi
 *   $ ...
 * </pre>
 * <p/>
 * Run it in Maven:
