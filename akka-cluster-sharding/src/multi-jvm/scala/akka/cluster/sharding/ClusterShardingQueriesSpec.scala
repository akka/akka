...
object ClusterShardingQueriesSpecConfig extends MultiNodeClusterShardingConfig(additionalConfig = """
      ...
      runOn(controller) {
        within(10.seconds) {
          awaitAssert {
            ...
            pingProbe.receiveWhile(messages = 20) { case PingPongActor.Pong =>
              ()
            }
          }
        }
