...
trait ActorContext[T] {
   ...
   * actor message processing thread, such as Future/CompletionStage callbacks.
   */
   ...
   * than the ordinary actor message processing thread, such as Future/CompletionStage callbacks.
   */
