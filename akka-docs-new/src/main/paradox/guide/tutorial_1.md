...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_1/ActorHierarchyExperiments.java) { #print-refs }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_1/ActorHierarchyExperiments.java) { #start-stop }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_1/ActorHierarchyExperiments.java) { #supervise }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_1/IotSupervisor.java) { #iot-supervisor }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_1/IotMain.java) { #iot-app }
