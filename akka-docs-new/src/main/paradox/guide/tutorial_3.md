...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/Device.java) { #device-with-register }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceTest.java) { #device-registration-tests }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroup.java) { #device-group-register }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroupTest.java) { #device-group-test-registration }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroupTest.java) { #device-group-test3 }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroup.java) { #device-group-remove }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroup.java) { #device-group-full }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceGroupTest.java) { #device-group-list-terminate-test }
...
Java
:   @@snip [Hello.java](../../../test/java/jdocs/tutorial_3/DeviceManager.java) { #device-manager-full }
