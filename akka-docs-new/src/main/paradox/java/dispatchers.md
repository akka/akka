...
to execute arbitrary code, for instance @ref[Futures](futures.md#futures-java).
...
@@snip [DispatcherDocTest.java](code/docs/dispatcher/DispatcherDocTest.java) { #lookup }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #defining-dispatcher-in-config }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #defining-dispatcher-in-code }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #defining-fixed-pool-size-dispatcher }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #defining-pinned-dispatcher }
