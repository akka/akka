...
@@snip [MyEndpoint.java](code/docs/camel/MyEndpoint.java) { #Consumer-mina }
...
@@snip [Orders.java](code/docs/camel/Orders.java) { #Producer }
...
@@snip [ProducerTestBase.java](code/docs/camel/ProducerTestBase.java) { #TellProducer }
...
@@snip [CamelExtensionTest.java](code/docs/camel/CamelExtensionTest.java) { #CamelExtension }
...
@@snip [CamelExtensionTest.java](code/docs/camel/CamelExtensionTest.java) { #CamelExtensionAddComponent }
...
@@snip [ActivationTestBase.java](code/docs/camel/ActivationTestBase.java) { #CamelActivation }
...
@@snip [ActivationTestBase.java](code/docs/camel/ActivationTestBase.java) { #CamelDeactivation }
...
@@snip [Consumer1.java](code/docs/camel/Consumer1.java) { #Consumer1 }
...
@@snip [Consumer2.java](code/docs/camel/Consumer2.java) { #Consumer2 }
...
@@snip [Consumer3.java](code/docs/camel/Consumer3.java) { #Consumer3 }
...
@@snip [Consumer4.java](code/docs/camel/Consumer4.java) { #Consumer4 }
...
@@snip [Producer1.java](code/docs/camel/Producer1.java) { #Producer1 }
...
@@snip [ProducerTestBase.java](code/docs/camel/ProducerTestBase.java) { #AskProducer }
...
@@snip [ResponseReceiver.java](code/docs/camel/ResponseReceiver.java) { #RouteResponse }

@@snip [Forwarder.java](code/docs/camel/Forwarder.java) { #RouteResponse }

@@snip [OnRouteResponseTestBase.java](code/docs/camel/OnRouteResponseTestBase.java) { #RouteResponse }
...
@@snip [Transformer.java](code/docs/camel/Transformer.java) { #TransformOutgoingMessage }
...
@@snip [OnewaySender.java](code/docs/camel/OnewaySender.java) { #Oneway }
...
@@snip [ProducerTestBase.java](code/docs/camel/ProducerTestBase.java) { #Correlate }
...
@@snip [MyActor.java](code/docs/camel/MyActor.java) { #ProducerTemplate }

For initiating a two-way message exchange, one of the
`ProducerTemplate.request*` methods must be used.

@@snip [RequestBodyActor.java](code/docs/camel/RequestBodyActor.java) { #RequestProducerTemplate }
...
@ref[dispatcher](dispatchers.md#dispatchers-java) for the producer. The Camel processor is 
...
@@snip [Responder.java](code/docs/camel/Responder.java) { #CustomRoute }

@@snip [CustomRouteBuilder.java](code/docs/camel/CustomRouteBuilder.java) { #CustomRoute }

@@snip [CustomRouteTestBase.java](code/docs/camel/CustomRouteTestBase.java) { #CustomRoute }
...
@@snip [ErrorThrowingConsumer.java](code/docs/camel/ErrorThrowingConsumer.java) { #ErrorThrowingConsumer }
