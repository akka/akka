<a id="persistence-schema-evolution-java"></a>
# Persistence - Schema Evolution

When working on long running projects using @ref[Persistence](persistence.md#persistence-java), or any kind of [Event Sourcing](http://martinfowler.com/eaaDev/EventSourcing.html) architectures,
...
type to `PersistentActor` s and @ref[persistence queries](persistence-query.md#persistence-query-java). This allows the business logic layer to focus on solving business problems
...
Akka Persistence provides [Google Protocol Buffers](https://developers.google.com/protocol-buffers/) based serializers (using @ref[Akka Serialization](serialization.md#serialization-java))
...
This section aims to highlight the complete basics on how to define custom serializers using @ref[Akka Serialization](serialization.md#serialization-java).
...
> **Note:**
Read the @ref[Akka Serialization](serialization.md#serialization-java) docs to learn more about defining custom serializers,
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #simplest-custom-serializer-model }

Next we implement a serializer (or extend an existing one to be able to handle the new `Person` class):

@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #simplest-custom-serializer }
...
Please refer to the @ref[Akka Serialization](serialization.md#serialization-java) documentation for more advanced use of serializers,
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #protobuf-read-optional-model }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #protobuf-read-optional }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #rename-plain-json }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #string-serializer-skip-deleved-event-by-manifest }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #string-serializer-skip-deleved-event-by-manifest-adapter }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #detach-models }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #detach-models-adapter }
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #detach-models-adapter-json }
...
using @ref[Persistence Query](persistence-query.md#persistence-query-java) would not be an efficient way to go about this, without compromising the
...
@@snip [PersistenceSchemaEvolutionDocTest.java](code/docs/persistence/PersistenceSchemaEvolutionDocTest.java) { #split-events-during-recovery }
