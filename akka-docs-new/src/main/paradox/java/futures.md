...
See also @ref[Actors (Java with Lambda Support)](lambda-index-actors.md#actor-java-lambda) for Java compatibility.
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports1 #imports7 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #diy-execution-context }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports1 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #ask-blocking }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #pipe-to }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports2 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #future-eval }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #successful }

Or failures:

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #failed }

It is also possible to create an empty `Promise`, to be filled later, and obtain the corresponding `Future`:

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #promise }

For these examples `PrintResult` is defined as follows:

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #print-result }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #map }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports3 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #sequence }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports4 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #traverse }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports5 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #fold }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports6 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #reduce }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #onSuccess }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #onFailure }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #onComplete }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #and-then }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #fallback-to }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #zip }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #recover }
...
@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #try-recover }

## After

`akka.pattern.Patterns.after` makes it easy to complete a `Future` with a value or exception after a timeout.

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #imports8 }

@@snip [FutureDocTest.java](code/docs/future/FutureDocTest.java) { #after }