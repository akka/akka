...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #router-in-actor }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #round-robin-pool-1 }

Here is the same example, but with the router configuration provided programmatically instead of
from configuration.

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #round-robin-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #remoteRoutees }

#### Senders

When a routee sends a message, it can @ref[set itself as the sender
](untyped-actors.md#actors-tell-sender-java).

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #reply-with-self }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #reply-with-parent }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #supervision }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #round-robin-group-1 }

Here is the same example, but with the router configuration provided programmatically instead of
from configuration.

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #round-robin-group-2 }

The routee actors are created externally from the router:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #create-workers }

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #create-worker-actors }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #create-parent }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #round-robin-group-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #random-pool-1 }

RandomPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #random-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #random-group-1 }

RandomGroup defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #random-group-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #balancing-pool-1 }

BalancingPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #balancing-pool-2 }
...
can be configured as explained in @ref[Dispatchers](dispatchers.md#dispatchers-java). In situations where the
...
on how to implement your custom mailbox in @ref[Mailboxes](mailboxes.md#mailboxes-java).
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #smallest-mailbox-pool-1 }

SmallestMailboxPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #smallest-mailbox-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcast-pool-1 }

BroadcastPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcast-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcast-group-1 }

BroadcastGroup defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #broadcast-group-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #scatter-gather-pool-1 }

ScatterGatherFirstCompletedPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #scatter-gather-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #scatter-gather-group-1 }

ScatterGatherFirstCompletedGroup defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #scatter-gather-group-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #tail-chopping-pool-1 }

TailChoppingPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #tail-chopping-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #tail-chopping-group-1 }

TailChoppingGroup defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #tail-chopping-group-2 }
...
@@snip [ConsistentHashingRouterDocTest.java](code/docs/jrouting/ConsistentHashingRouterDocTest.java) { #cache-actor }

@@snip [ConsistentHashingRouterDocTest.java](code/docs/jrouting/ConsistentHashingRouterDocTest.java) { #consistent-hashing-router }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #consistent-hashing-pool-1 }

ConsistentHashingPool defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #consistent-hashing-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #consistent-hashing-group-1 }

ConsistentHashingGroup defined in code:

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #paths #consistent-hashing-group-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcastDavyJonesWarning }
...
receives a `PoisonPill` message, that actor will be stopped. See the @ref[PoisonPill](untyped-actors.md#poison-pill-java)
documentation for details.

@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #poisonPill }
...
See the documentation on @ref[Stopping actors](untyped-actors.md#stopping-actors-java) for more information.
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcastPoisonPill }
...
@ref[Killing an Actor](untyped-actors.md#killing-actors-java) for general information about how actors handle `Kill` messages.
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #kill }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #broadcastKill }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #resize-pool-1 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #resize-pool-2 }
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #optimal-size-exploring-resize-pool }
...
@@snip [CustomRouterDocTest.java](code/docs/jrouting/CustomRouterDocTest.java) { #routing-logic }
...
@@snip [CustomRouterDocTest.java](code/docs/jrouting/CustomRouterDocTest.java) { #unit-test-logic }
...
@@snip [RedundancyGroup.java](code/docs/jrouting/RedundancyGroup.java) { #group }

This can be used exactly as the router actors provided by Akka.

@@snip [CustomRouterDocTest.java](code/docs/jrouting/CustomRouterDocTest.java) { #usage-1 }
...
@@snip [CustomRouterDocTest.java](code/docs/jrouting/CustomRouterDocTest.java) { #usage-2 }

## Configuring Dispatchers

The dispatcher for created children of the pool will be taken from
`Props` as described in @ref[Dispatchers](../scala/dispatchers.md#dispatchers-scala).
...
@@snip [RouterDocTest.java](code/docs/jrouting/RouterDocTest.java) { #dispatchers }
