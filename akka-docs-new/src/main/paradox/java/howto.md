...
@ref[HowTo: Common Patterns](../scala/howto.md#howto-scala) useful even though the example code is written in Scala.
...
@@snip [SchedulerPatternTest.java](code/docs/pattern/SchedulerPatternTest.java) { #schedule-constructor }
...
@@snip [SchedulerPatternTest.java](code/docs/pattern/SchedulerPatternTest.java) { #schedule-receive }
...
@@snip [SupervisedAsk.java](code/docs/pattern/SupervisedAsk.java) { # }
...
@@snip [SupervisedAskSpec.java](code/docs/pattern/SupervisedAskSpec.java) { # }
...
@@snip [JavaTemplate.java](code/docs/pattern/JavaTemplate.java) { #all-of-it }
