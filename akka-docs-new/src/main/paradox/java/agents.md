...
@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-agent #create type=java }
...
@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #read-get type=java }
...
@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-future #read-future type=java }

See @ref[Futures](futures.md#futures-java) for more information on `Futures`.
...
@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-function #send type=java }
...
@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-function #send-off type=java }

All `send` methods also have a corresponding `alter` method that returns a `Future`.
See @ref[Futures](futures.md#futures-java) for more information on `Futures`.

@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-future #import-function #alter type=java }

@@snip [AgentDocTest.java](code/docs/agent/AgentDocTest.java) { #import-future #import-function #alter-off type=java }
