...
@@snip [MyBoundedUntypedActor.java](code/docs/actor/MyBoundedUntypedActor.java) { #my-bounded-untyped-actor }
...
Now every time you create an actor of type `MyBoundedUntypedActor` it will try to get a bounded
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #prio-mailbox }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #prio-dispatcher }
...
@@snip [DispatcherDocTest.java](code/docs/dispatcher/DispatcherDocTest.java) { #defining-mailbox-in-config }

Or code like this:

@@snip [DispatcherDocTest.java](code/docs/dispatcher/DispatcherDocTest.java) { #defining-mailbox-in-code }
...
@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #control-aware-mailbox-messages }

And then an example on how you would use it:

@@snip [DispatcherDocTest.java](../java/code/docs/dispatcher/DispatcherDocTest.java) { #control-aware-dispatcher }

## Creating your own Mailbox type

An example is worth a thousand quacks:

@@snip [MyUnboundedJMailbox.java](code/docs/dispatcher/MyUnboundedJMailbox.java) { #mailbox-implementation-example }

@@snip [MyUnboundedJMessageQueueSemantics.java](code/docs/dispatcher/MyUnboundedJMessageQueueSemantics.java) { #mailbox-implementation-example }
...
@@snip [DispatcherDocTest.java](code/docs/dispatcher/DispatcherDocTest.java) { #require-mailbox-on-actor }
