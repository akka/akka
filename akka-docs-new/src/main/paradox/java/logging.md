...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #imports }

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #my-actor }
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #array }
...
making sure to use an async logging backend though. (See [Using the SLF4J API directly](#slf4j-directly-java))
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #imports #imports-listener }

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #my-event-listener }
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #imports-mdc }

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #mdc-actor }
