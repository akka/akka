...
@@snip [IODocTest.java](code/docs/io/japi/IODocTest.java) { #imports }
...
@@snip [EchoManager.java](code/docs/io/japi/EchoManager.java) { #manager }
...
@@snip [IODocTest.java](code/docs/io/japi/IODocTest.java) { #client }
...
@@snip [IODocTest.java](code/docs/io/japi/IODocTest.java) { #server }
...
@@snip [IODocTest.java](code/docs/io/japi/IODocTest.java) { #simplistic-handler }
...
available [on GitHub ](@github@/akka-docs/rst/java/code/docs/io/japi).
...
@@snip [EchoManager.java](code/docs/io/japi/EchoManager.java) { #echo-manager }

With this preparation let us dive into the handler itself:

@@snip [SimpleEchoHandler.java](code/docs/io/japi/SimpleEchoHandler.java) { #simple-echo-handler }
...
@@snip [SimpleEchoHandler.java](code/docs/io/japi/SimpleEchoHandler.java) { #simple-helpers }
...
@@snip [EchoHandler.java](code/docs/io/japi/EchoHandler.java) { #echo-handler }
...
@@snip [EchoHandler.java](code/docs/io/japi/EchoHandler.java) { #buffering }
...
@@snip [EchoHandler.java](code/docs/io/japi/EchoHandler.java) { #closing }
...
@@snip [EchoHandler.java](code/docs/io/japi/EchoHandler.java) { #helpers }
...
@@snip [JavaReadBackPressure.java](code/docs/io/JavaReadBackPressure.java) { #pull-reading-echo }
...
@@snip [JavaReadBackPressure.java](code/docs/io/JavaReadBackPressure.java) { #pull-mode-connect }
...
@@snip [JavaReadBackPressure.java](code/docs/io/JavaReadBackPressure.java) { #pull-mode-bind }
...
@@snip [JavaReadBackPressure.java](code/docs/io/JavaReadBackPressure.java) { #pull-accepting }
