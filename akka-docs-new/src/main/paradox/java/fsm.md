...
@ref[FSM](../scala/fsm.md#fsm-scala)), Java’s verbosity does not lend itself well to the same
...
@@snip [FSMDocTest.java](code/docs/actor/FSMDocTest.java) { #imports-data }

@@snip [FSMDocTest.java](code/docs/actor/FSMDocTest.java) { #base }
...
@@snip [FSMDocTest.java](code/docs/actor/FSMDocTest.java) { #data }
...
@@snip [FSMDocTest.java](code/docs/actor/FSMDocTest.java) { #imports-actor }

@@snip [FSMDocTest.java](code/docs/actor/FSMDocTest.java) { #actor }

The trick here is to factor out common functionality like `whenUnhandled`
and `transition` in order to obtain a few well-defined points for
