...
maintenance releases does not apply to the `akka.actor.AbstractFSM`, related classes and the
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #simple-imports }

The contract of our “Buncher” actor is that it accepts or produces the following messages:

@@snip [Events.java](code/docs/actorlambda/fsm/Events.java) { #simple-events }
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #simple-state }
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #simple-fsm }
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #unhandled-elided }
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #transition-elided }
...
using the <!-- FIXME: More than one link target with name akka-testkit in path Some(/java/lambda-fsm.rst) --> akka-testkit, here using JUnit as an example:

@@snip [BuncherTest.java](code/docs/actorlambda/fsm/BuncherTest.java) { #test-code }
...
@@snip [Buncher.java](code/docs/actorlambda/fsm/Buncher.java) { #when-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #NullFunction }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #unhandled-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #modifier-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #transition-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #alt-transition-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #stop-syntax }
...
@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #termination-syntax }
...
actor. There are specialized tools available as described in @ref[Testing Finite State Machines](../scala/testing.md#testfsmref)
and in the following.

### Event Tracing

The setting `akka.actor.debug.fsm` in <!-- FIXME: More than one link target with name configuration in path Some(/java/lambda-fsm.rst) --> configuration enables logging of an
event trace by `LoggingFSM` instances:

@@snip [FSMDocTest.java](code/docs/actorlambda/fsm/FSMDocTest.java) { #logging-fsm }
...
A bigger FSM example contrasted with Actor's `become`/`unbecome` can be found in
the [Lightbend Activator ](http://www.lightbend.com/platform/getstarted) template named
[Akka FSM in Scala ](http://www.lightbend.com/activator/template/akka-sample-fsm-java-lambda)