...
familiarize yourself with @ref[Actor Systems](../general/actor-systems.md#actor-systems) and <!-- FIXME: More than one link target with name supervision in path Some(/java/untyped-actors.rst) --> supervision and it
may also help to read @ref[Actor References, Paths and Addresses](../general/addressing.md#addressing).
...
@@snip [MyUntypedActor.java](code/docs/actor/MyUntypedActor.java) { #my-untyped-actor }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-props }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #creating-props-config }
...
The third line demonstrates the use of a `Creator<T extends Actor>`. The
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #parametric-creator }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #props-factory }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #messages-in-companion }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-actorRef }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #system-actorOf }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #context-actorOf }
...
see @ref[Actor Systems](../general/actor-systems.md#actor-systems).
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-indirect }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #creating-indirectly }
...
@@snip [InboxDocTest.java](code/docs/actor/InboxDocTest.java) { #inbox }
...
@@snip [InboxDocTest.java](code/docs/actor/InboxDocTest.java) { #watch }
 ...
 * `getSender()` reference sender Actor of the last received message, typically used as described in [UntypedActor.Reply](#untypedactor-reply)
 * 
 ...
 * 
    ...
    * hotswap behavior stack as described in [UntypedActor.HotSwap](#untypedactor-hotswap)

The remaining visible methods are user-overridable life-cycle hooks which are
described in the following:

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #lifecycle-callbacks }

The implementations shown above are the defaults provided by the `UntypedActor`
class.

<a id="actor-lifecycle-java"></a>
### Actor Lifecycle
...
or the `ActorSystem` (see [Stopping actors](#stopping-actors-java)).
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-terminated }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #watch }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #preStart }
...
processing a message (see <!-- FIXME: More than one link target with name supervision in path Some(/java/untyped-actors.rst) --> supervision). This restart involves the hooks
mentioned above:
...
As described in @ref[Actor References, Paths and Addresses](../general/addressing.md#addressing), each actor has a unique logical path, which
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #selection-local }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #selection-wildcard }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-identify }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #identify }
...
Remote actor addresses may also be looked up, if @ref[remoting](remoting.md#remoting-java) is enabled:

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #selection-remote }

An example demonstrating remote actor look-up is given in @ref[Remoting Sample](remoting.md#remote-sample-java).
...
@@snip [ImmutableMessage.java](code/docs/actor/ImmutableMessage.java) { #immutable-message }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #tell }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-ask }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #ask-pipe }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #reply-exception }

If the actor does not complete the future, it will expire after the timeout period,
specified as parameter to the `ask` method; this will complete the
`Future` with an `AskTimeoutException`.

See @ref[Futures](futures.md#futures-java) for more information on how to await or query a
future.
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #forward }
...
](http://commons.apache.org/beanutils/api/org/apache/commons/beanutils/MethodUtils.html#invokeMethod(java.lang.Object,%20java.lang.String,%20java.lang.Object))
to invoke a named method whose parameter type matches the message type.

<a id="untypedactor-reply"></a>
## Reply to messages
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #reply }
...
@@snip [MyReceiveTimeoutUntypedActor.java](code/docs/actor/MyReceiveTimeoutUntypedActor.java) { #receive-timeout }
...
@@snip [MyStoppingActor.java](code/docs/actor/MyStoppingActor.java) { #my-stopping-actor }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #postStop }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #poison-pill }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-gracefulStop }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #gracefulStop }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #gracefulStop-actor }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-procedure }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #hot-swap-actor }
...
@@snip [UntypedActorSwapper.java](code/docs/actor/UntypedActorSwapper.java) { #swapper }
...
control over the mailbox, see the documentation on mailboxes: @ref[Mailboxes](mailboxes.md#mailboxes-java).

Here is an example of the `UntypedActorWithStash` class in action:

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #import-stash }

@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #stash }
...
@@snip [UntypedActorDocTest.java](code/docs/actor/UntypedActorDocTest.java) { #kill }
...
supervision process is started (see <!-- FIXME: More than one link target with name supervision in path Some(/java/untyped-actors.rst) --> supervision). Depending on the
...
@@snip [InitializationDocSpecJava.java](code/docs/actor/InitializationDocSpecJava.java) { #preStartInit }
...
@@snip [InitializationDocSpecJava.java](code/docs/actor/InitializationDocSpecJava.java) { #messageInit }
