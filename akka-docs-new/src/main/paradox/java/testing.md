...
and @ref[AtLeastOnceDelivery](persistence.md#at-least-once-delivery-java) provided by @ref[Akka Persistence](persistence.md#persistence-java).
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-actor-ref }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-behavior }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-expecting-exceptions }
...
The `JavaTestKit` class contains a collection of tools which makes this
common task easy.

@@snip [TestKitSampleTest.java](code/docs/testkit/TestKitSampleTest.java) { #fullsample }

The `JavaTestKit` contains an actor named `testActor` which is the
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-expect }
...
obey the innermost enclosing `Within` as detailed [below
 ...
 * 
   **ExpectMsg<T>**
   @@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-expectmsg }
   The `match(Object in)` method will be evaluated once a message has
...
expectation fails with an `AssertionError`, otherwise the matched
and possibly transformed object is stored for retrieval using the
`get()` method.
 * 
   **ReceiveWhile<T>**
   @@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-receivewhile }
 ...
 * 
   **AwaitCond**
   @@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-awaitCond }
...
anything in scope.
    * **AwaitAssert**
   @@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-awaitAssert }
   This general construct is not connected with the test kit’s message
 ...
 * 
   **IgnoreMsg**
   @@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-ignoreMsg }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-event-filter }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-within }

The block in `Within.run()` must complete after a @ref[Duration](../common/duration.md#duration) which
...
internally scaled by a factor taken from the [Configuration](#configuration),
`akka.test.timefactor`, which defaults to 1.

You can scale other durations with the same factor by using `dilated` method
in `JavaTestKit`.

@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #duration-dilation }
...
at the `testActor` when using the `JavaTestKit` as shown until now.
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-probe }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-probe-with-custom-name }

Probes may also be equipped with custom assertions to make your test code even
more concise and clear:

@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-special-probe }

You have complete flexibility here in mixing and matching the
`JavaTestKit` facilities with your own checks and choosing an intuitive
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-probe-watch }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-probe-reply }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-probe-forward }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-auto-pilot }
...
described [above](#javatestkit-within) is local to each probe. Hence, probes
do not react to each other's deadlines or to the deadline set in an enclosing
`JavaTestKit` instance:

@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #test-within-probe }
...
@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-example }
...
@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-dependentchild }
...
@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-TestProbe-parent }
...
@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-fabricated-parent-creator }

@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-fabricated-parent }
...
@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-dependentparent }

@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #test-dependentparent-generic }

Creating the `Actor` is straightforward and the function may look like this in your test code:

@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #child-maker-test }

And like this in your application code:

@@snip [ParentChildTest.java](code/docs/testkit/ParentChildTest.java) { #child-maker-prod }
...
@@snip [TestKitDocTest.java](code/docs/testkit/TestKitDocTest.java) { #calling-thread-dispatcher }
