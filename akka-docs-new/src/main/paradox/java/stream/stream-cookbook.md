...
If you need a quick reference of the available processing stages used in the recipes see @ref[stages-overview_java](stages-overview.md#stages-overview-java).

## Working with Flows

In this collection we show simple recipes that involve linear flows. The recipes in this section are rather
general, more targeted recipes are available as separate sections (@ref[Buffers and working with rate](stream-rate.md#stream-rate-java), @ref[Working with streaming IO](stream-io.md#stream-io-java)).
...
@@snip [RecipeLoggingElements.java](../code/docs/stream/javadsl/cookbook/RecipeLoggingElements.java) { #println-debug }
...
@@snip [RecipeLoggingElements.java](../code/docs/stream/javadsl/cookbook/RecipeLoggingElements.java) { #log-custom }
...
@@snip [RecipeFlattenList.java](../code/docs/stream/javadsl/cookbook/RecipeFlattenList.java) { #flattening-lists }
...
@@snip [RecipeSeq.java](../code/docs/stream/javadsl/cookbook/RecipeSeq.java) { #draining-to-list-unsafe }

Rather, use `limit` or `take` to ensure that the resulting `List` will contain only up to `MAX_ALLOWED_SIZE` elements:

@@snip [RecipeSeq.java](../code/docs/stream/javadsl/cookbook/RecipeSeq.java) { #draining-to-list-safe }
...
@@snip [RecipeDigest.java](../code/docs/stream/javadsl/cookbook/RecipeDigest.java) { #calculating-digest }

@@snip [RecipeDigest.java](../code/docs/stream/javadsl/cookbook/RecipeDigest.java) { #calculating-digest2 }
...
@@snip [RecipeParseLines.java](../code/docs/stream/javadsl/cookbook/RecipeParseLines.java) { #parse-lines }
...
@@snip [RecipeReduceByKeyTest.java](../code/docs/stream/javadsl/cookbook/RecipeReduceByKeyTest.java) { #word-count }
...
@@snip [RecipeReduceByKeyTest.java](../code/docs/stream/javadsl/cookbook/RecipeReduceByKeyTest.java) { #reduce-by-key-general }

@@snip [RecipeReduceByKeyTest.java](../code/docs/stream/javadsl/cookbook/RecipeReduceByKeyTest.java) { #reduce-by-key-general2 }
...
@@snip [RecipeMultiGroupByTest.java](../code/docs/stream/javadsl/cookbook/RecipeMultiGroupByTest.java) { #multi-groupby }
...
@@snip [RecipeManualTrigger.java](../code/docs/stream/javadsl/cookbook/RecipeManualTrigger.java) { #manually-triggered-stream }
...
@@snip [RecipeManualTrigger.java](../code/docs/stream/javadsl/cookbook/RecipeManualTrigger.java) { #manually-triggered-stream-zipwith }
...
@@snip [RecipeWorkerPool.java](../code/docs/stream/javadsl/cookbook/RecipeWorkerPool.java) { #worker-pool }

@@snip [RecipeWorkerPool.java](../code/docs/stream/javadsl/cookbook/RecipeWorkerPool.java) { #worker-pool2 }
...
@@snip [RecipeSimpleDrop.java](../code/docs/stream/javadsl/cookbook/RecipeSimpleDrop.java) { #simple-drop }
...
@@snip [RecipeDroppyBroadcast.java](../code/docs/stream/javadsl/cookbook/RecipeDroppyBroadcast.java) { #droppy-bcast }

@@snip [RecipeDroppyBroadcast.java](../code/docs/stream/javadsl/cookbook/RecipeDroppyBroadcast.java) { #droppy-bcast2 }
...
@@snip [RecipeMissedTicks.java](../code/docs/stream/javadsl/cookbook/RecipeMissedTicks.java) { #missed-ticks }
...
@@snip [RecipeHold.java](../code/docs/stream/javadsl/cookbook/RecipeHold.java) { #hold-version-1 }
...
@@snip [RecipeHold.java](../code/docs/stream/javadsl/cookbook/RecipeHold.java) { #hold-version-2 }
...
@@snip [RecipeGlobalRateLimit.java](../code/docs/stream/javadsl/cookbook/RecipeGlobalRateLimit.java) { #global-limiter-actor }
...
@@snip [RecipeGlobalRateLimit.java](../code/docs/stream/javadsl/cookbook/RecipeGlobalRateLimit.java) { #global-limiter-flow }
...
@@snip [RecipeByteStrings.java](../code/docs/stream/javadsl/cookbook/RecipeByteStrings.java) { #bytestring-chunker }

@@snip [RecipeByteStrings.java](../code/docs/stream/javadsl/cookbook/RecipeByteStrings.java) { #bytestring-chunker2 }
...
@@snip [RecipeByteStrings.java](../code/docs/stream/javadsl/cookbook/RecipeByteStrings.java) { #bytes-limiter }

@@snip [RecipeByteStrings.java](../code/docs/stream/javadsl/cookbook/RecipeByteStrings.java) { #bytes-limiter2 }
...
@@snip [RecipeByteStrings.java](../code/docs/stream/javadsl/cookbook/RecipeByteStrings.java) { #compacting-bytestrings }
...
@@snip [RecipeKeepAlive.java](../code/docs/stream/javadsl/cookbook/RecipeKeepAlive.java) { #inject-keepalive }