<a id="stream-customize-java"></a>
# Custom stream processing

While the processing vocabulary of Akka Streams is quite rich (see the @ref[Streams Cookbook](stream-cookbook.md#stream-cookbook-java) for examples) it
...
(this is explained in more detail in the section @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-java)).

@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #simple-source }
...
`Source.fromGraph` (see @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-java) for more details about graphs and DSLs). Now we can use the
source as any other built-in one:

@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #simple-source-usage }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #simple-sink }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #one-to-one }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #many-to-one }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #one-to-many }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #simpler-one-to-many }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #graph-stage-chain }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #timed }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #async-side-channel }
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #materialized }
...
See @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-java) for an explanation on how attributes work.
...
@@snip [GraphStageDocTest.java](../code/docs/stream/GraphStageDocTest.java) { #detached }
