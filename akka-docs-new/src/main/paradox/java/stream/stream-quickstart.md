...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #stream-imports }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #other-imports }

Now we will start with a rather simple source, emitting the integers 1 to 100:

@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #create-source }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #run-source }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #create-materializer }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #transform-source }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #transform-sink }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #use-transformed-sink }
...
@@snip [QuickStartDocTest.java](../code/docs/stream/QuickStartDocTest.java) { #add-streams }
...
transformation combinators to choose from, see also @ref[stages-overview_java](stages-overview.md#stages-overview-java).
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #model }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #materializer-setup }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #tweet-source }
...
materialization ([see below](#materialized-values-quick-java))—`BoxedUnit` (from the `scala.runtime`
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #authors-filter-map }
...
the [Sink class ](http://doc.akka.io/japi/akka-stream-and-http-experimental/@version@/akka/stream/javadsl/Sink.html).
For now let's simply print each author:

@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #authors-foreachsink-println }

or by using the shorthand version (which are defined only for the most popular Sinks such as `Sink.fold` and `Sink.foreach`):

@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #authors-foreach-println }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #first-sample }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #hashtags-mapConcat }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #graph-dsl-broadcast }

As you can see, we use graph builder `b` to construct the graph using `UniformFanOutShape` and `Flow` s.

`GraphDSL.create` returns a `Graph`, in this example a `Graph<ClosedShape,Unit>` where
...
explained in detail in @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-java). It is also possible to wrap complex computation graphs
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #tweets-slow-consumption-dropHead }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #tweets-fold-count }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #tweets-runnable-flow-materialized-twice }
...
@@snip [TwitterStreamQuickstartDocTest.java](../code/docs/stream/TwitterStreamQuickstartDocTest.java) { #tweets-fold-count-oneline }
