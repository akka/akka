...
@@snip [FlowParallelismDocTest.java](../code/docs/stream/FlowParallelismDocTest.java) { #pipelining }
...
For more details about the behavior of these and how to add additional buffers refer to @ref[Buffers and working with rate](../../scala/stream/stream-rate.md#stream-rate-scala).
...
@@snip [FlowParallelismDocTest.java](../code/docs/stream/FlowParallelismDocTest.java) { #parallelism }
...
@@snip [FlowParallelismDocTest.java](../code/docs/stream/FlowParallelismDocTest.java) { #parallel-pipeline }
...
@@snip [FlowParallelismDocTest.java](../code/docs/stream/FlowParallelismDocTest.java) { #pipelined-parallel }
