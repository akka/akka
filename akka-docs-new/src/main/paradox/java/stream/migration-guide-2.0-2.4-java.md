<a id="migration-streams-2-0-2-4-java"></a>
...
information see [the documentation](https://github.com/scala/scala-java8-compat).
...
@@snip [MigrationsJava.java](../code/docs/stream/MigrationsJava.java) { #expand-continually }
...
@@snip [MigrationsJava.java](../code/docs/stream/MigrationsJava.java) { #expand-state }
...
@@snip [MigrationsJava.java](../code/docs/stream/MigrationsJava.java) { #async }
...
@@snip [MigrationsJava.java](../code/docs/stream/MigrationsJava.java) { #asPublisher-import }

@@snip [MigrationsJava.java](../code/docs/stream/MigrationsJava.java) { #asPublisher }
...
should be replaced by `GraphStage` (@ref[Custom processing with GraphStage](stream-customize.md#graphstage-java)) which is now a single powerful API
for custom stream processing.

### Update procedure

Please consult the `GraphStage` documentation (@ref[Custom processing with GraphStage](stream-customize.md#graphstage-java)) and the [previous migration guide](http://doc.akka.io/docs/akka-stream-and-http-experimental/2.0.2/java/migration-guide-1.0-2.x-java.html#AsyncStage_has_been_replaced_by_GraphStage)
