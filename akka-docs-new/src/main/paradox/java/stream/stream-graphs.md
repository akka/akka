...
Akka Streams currently provide these junctions (for a detailed list see @ref[stages-overview_java](stages-overview.md#stages-overview-java)):
...
@@snip [GraphDSLDocTest.java](../code/docs/stream/GraphDSLDocTest.java) { #simple-graph-dsl }
...
@@snip [GraphDSLDocTest.java](../code/docs/stream/GraphDSLDocTest.java) { #graph-dsl-reusing-a-flow }
...
@@snip [StreamPartialGraphDSLDocTest.java](../code/docs/stream/StreamPartialGraphDSLDocTest.java) { #simple-partial-graph-dsl }
...
@@snip [StreamPartialGraphDSLDocTest.java](../code/docs/stream/StreamPartialGraphDSLDocTest.java) { #source-from-partial-graph-dsl }
...
@@snip [StreamPartialGraphDSLDocTest.java](../code/docs/stream/StreamPartialGraphDSLDocTest.java) { #flow-from-partial-graph-dsl }
...
@@snip [StreamPartialGraphDSLDocTest.java](../code/docs/stream/StreamPartialGraphDSLDocTest.java) { #source-combine }

The same can be done for a `Sink` but in this case it will be fan-out:

@@snip [StreamPartialGraphDSLDocTest.java](../code/docs/stream/StreamPartialGraphDSLDocTest.java) { #sink-combine }
...
@@snip [BidiFlowDocTest.java](../code/docs/stream/BidiFlowDocTest.java) { #codec }
...
@@snip [BidiFlowDocTest.java](../code/docs/stream/BidiFlowDocTest.java) { #codec-impl }
...
@@snip [BidiFlowDocTest.java](../code/docs/stream/BidiFlowDocTest.java) { #framing }

With these implementations we can build a protocol stack and test it:

@@snip [BidiFlowDocTest.java](../code/docs/stream/BidiFlowDocTest.java) { #compose }
...
@@snip [GraphDSLDocTest.java](../code/docs/stream/GraphDSLDocTest.java) { #graph-dsl-matvalue }
...
@@snip [GraphDSLDocTest.java](../code/docs/stream/GraphDSLDocTest.java) { #graph-dsl-matvalue-cycle }
...
@@snip [GraphCyclesDocTest.java](../code/docs/stream/GraphCyclesDocTest.java) { #deadlocked }
...
@@snip [GraphCyclesDocTest.java](../code/docs/stream/GraphCyclesDocTest.java) { #unfair }
...
@@snip [GraphCyclesDocTest.java](../code/docs/stream/GraphCyclesDocTest.java) { #dropping }
...
@@snip [GraphCyclesDocTest.java](../code/docs/stream/GraphCyclesDocTest.java) { #zipping-dead }
...
@@snip [GraphCyclesDocTest.java](../code/docs/stream/GraphCyclesDocTest.java) { #zipping-live }
