<a id="stream-io-java"></a>
# Working with streaming IO

Akka Streams provides a way of handling File IO and TCP connections with Streams.
While the general approach is very similar to the @ref[Actor based TCP handling](../io-tcp.md#io-java-tcp) using Akka IO,
...
@@snip [StreamTcpDocTest.java](../code/docs/stream/io/StreamTcpDocTest.java) { #echo-server-simple-bind }
...
to handle and emit ByteStrings from and to the TCP Socket. Since one `ByteString` does not have to necessarily
...
@@snip [StreamTcpDocTest.java](../code/docs/stream/io/StreamTcpDocTest.java) { #echo-server-simple-handle }
...
@@snip [StreamTcpDocTest.java](../code/docs/stream/io/StreamTcpDocTest.java) { #repl-client }
...
@@snip [StreamTcpDocTest.java](../code/docs/stream/io/StreamTcpDocTest.java) { #welcome-banner-chat-server }
...
@@snip [StreamFileDocTest.java](../code/docs/stream/io/StreamFileDocTest.java) { #file-source }
...
@@snip [StreamFileDocTest.java](../code/docs/stream/io/StreamFileDocTest.java) { #custom-dispatcher-code }