...
@@snip [CompositionDocTest.java](../code/docs/stream/CompositionDocTest.java) { #complex-graph }
...
@@snip [CompositionDocTest.java](../code/docs/stream/CompositionDocTest.java) { #mat-combine-4a }
