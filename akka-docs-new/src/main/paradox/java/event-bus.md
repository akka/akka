...
@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #event-bus-api }
...
@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #lookup-bus }

A test for this implementation may look like this:

@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #lookup-bus-test }
...
@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #subchannel-bus }

A test for this implementation may look like this:

@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #subchannel-bus-test }
...
@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #scanning-bus }

A test for this implementation may look like this:

@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #scanning-bus-test }
...
@ref[DeathWatch](untyped-actors.md#deathwatch-java): subscribers as well as classifiers are of
type `ActorRef`.
...
@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #actor-bus }

A test for this implementation may look like this:

@@snip [EventBusDocTest.java](code/docs/event/EventBusDocTest.java) { #actor-bus-test }
...
carrying @ref[log messages](logging.md#logging-java) and [Dead Letters](#dead-letters) and may be
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #imports-deadletter }

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #deadletter-actor }

it can be subscribed like this:

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #deadletters }
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #superclass-subscription-eventstream }
...
If you need to broadcast events in an Akka cluster, *without* knowing your recipients explicitly (i.e. obtaining their ActorRefs), you may want to look into: @ref[Distributed Publish Subscribe in Cluster](distributed-pub-sub.md#distributed-pub-sub-java).
...
As described at @ref[Stopping actors](untyped-actors.md#stopping-actors-java), messages queued when an actor
...
@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #suppressed-deadletters }

or all dead letters (including the suppressed ones):

@@snip [LoggingDocTest.java](code/docs/event/LoggingDocTest.java) { #all-deadletters }
