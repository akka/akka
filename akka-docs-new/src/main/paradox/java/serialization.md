...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #imports }

@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #programmatic }
...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #my-own-serializer }
...
for @ref[Persistence](persistence.md#persistence-java).
...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #my-own-serializer2 }
...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #actorref-serializer }
...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #external-address }
...
@@snip [SerializationDocTest.java](code/docs/serialization/SerializationDocTest.java) { #external-address-default }

### Deep serialization of Actors

The recommended approach to do deep serialization of internal actor state is to use Akka @ref[Persistence](persistence.md#persistence-java).
