...
@@snip [DataBot.java](code/docs/ddata/DataBot.java) { #data-bot }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #update }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #update-response1 }

@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #update-response2 }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #update-request-context }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #get }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #get-response1 }

@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #get-response2 }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #get-request-context }
...
@@snip [ShoppingCart.java](../../../../../akka-samples/akka-sample-distributed-data-java/src/main/java/sample/distributeddata/ShoppingCart.java) { #read-write-majority }

@@snip [ShoppingCart.java](../../../../../akka-samples/akka-sample-distributed-data-java/src/main/java/sample/distributeddata/ShoppingCart.java) { #get-cart }

@@snip [ShoppingCart.java](../../../../../akka-samples/akka-sample-distributed-data-java/src/main/java/sample/distributeddata/ShoppingCart.java) { #add-item }
...
@@snip [ShoppingCart.java](../../../../../akka-samples/akka-sample-distributed-data-java/src/main/java/sample/distributeddata/ShoppingCart.java) { #remove-item }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #subscribe }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #delete }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #pncounter }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #pncountermap }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #gset }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #orset }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #ormultimap }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #flag }
...
@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #lwwregister }

Instead of using timestamps based on `System.currentTimeMillis()` time it is possible to
use a timestamp value based on something else, for example an increasing version number
from a database record that is used for optimistic concurrency control.

@@snip [DistributedDataDocTest.java](code/docs/ddata/DistributedDataDocTest.java) { #lwwregister-custom-clock }
...
@@snip [TwoPhaseSet.java](code/docs/ddata/japi/TwoPhaseSet.java) { #twophaseset }

Data types should be immutable, i.e. "modifying" methods should return a new instance.

#### Serialization

The data types must be serializable with an @ref[Akka Serializer](serialization.md#serialization-java).
...
@@snip [TwoPhaseSetSerializer.java](code/docs/ddata/japi/protobuf/TwoPhaseSetSerializer.java) { #serializer }
...
@@snip [TwoPhaseSetSerializerWithCompression.java](code/docs/ddata/japi/protobuf/TwoPhaseSetSerializerWithCompression.java) { #compression }
...
@@snip [TwoPhaseSetSerializer2.java](code/docs/ddata/japi/protobuf/TwoPhaseSetSerializer2.java) { #serializer }
...
tutorial named [Akka Distributed Data Samples with Java ](http://www.lightbend.com/activator/template/akka-sample-distributed-data-java).
