...
For more details about the behavior of these and how to add additional buffers refer to @ref[Buffers and working with rate](stream-rate.md#stream-rate-scala).
