 ...
 * The top-down learners may want to peruse the @ref[Design Principles behind Akka Streams](../../general/stream/stream-design.md#stream-design) at this
point.
 * The bottom-up learners may feel more at home rummaging through the
@ref[Streams Cookbook](stream-cookbook.md#stream-cookbook-scala).
 * For a complete overview of the built-in processing stages you can look at the
table in @ref[stages-overview_scala](stages-overview.md#stages-overview-scala)
