...
@@snip [QuickStartDocSpec.scala](../code/docs/stream/QuickStartDocSpec.scala) { #main-app }
...
@@snip [QuickStartDocSpec.scala](../code/docs/stream/QuickStartDocSpec.scala) { #run-source-and-terminate }
