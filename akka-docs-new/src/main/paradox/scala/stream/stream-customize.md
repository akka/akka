<a id="stream-customize-scala"></a>
# Custom stream processing

While the processing vocabulary of Akka Streams is quite rich (see the @ref[Streams Cookbook](stream-cookbook.md#stream-cookbook-scala) for examples) it
...
(this is explained in more detail in the section @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-scala)). This is how this looks like:
...
`Source.fromGraph` (see @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-scala) for more details about graphs and DSLs). Now we can use the
...
See @ref[Modularity, Composition and Hierarchy](stream-composition.md#composition-scala) for an explanation on how attributes work.
