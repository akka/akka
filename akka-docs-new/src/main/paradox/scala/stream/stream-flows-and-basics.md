...
junctions like `Merge` or `Broadcast`. For the full list of built-in processing stages see @ref[stages-overview_scala](stages-overview.md#stages-overview-scala)
...
@@snip [FlowDocSpec.scala](../code/docs/stream/FlowDocSpec.scala) { #explicit-fusing }
