...
Please note that @ref[new remoting implementation (codename Artery)](remoting-artery.md#remoting-artery-scala) does not use Java 
...
remote messages. Please refer to the @ref[Serialization](serialization.md#serialization-scala) documentation as well as @ref[ByteBuffer based serialization](remoting-artery.md#remote-bytebuffer-serialization-scala) to learn how to do this.
...
enable this setting. When using @ref[Remoting (codename Artery)](remoting-artery.md#remoting-artery-scala) these serializers are enabled by default.
...
in the [Remote Configuration](#remote-configuration-scala) section.
...
@@snip [RemoteDeploymentDocTest.java](../java/code/docs/remoting/RemoteDeploymentDocTest.java) { #programmatic }
