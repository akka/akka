...
old remoting implementation. For the current stable remoting system please refer to @ref[Remoting](remoting.md#remoting-scala).
 ...
 * Remote failure detector triggers, i.e. remote watch is used. This is different when @ref[Akka Cluster](cluster-usage.md#cluster-usage-scala)
...
For more information please see @ref[Serialization](serialization.md#serialization-scala).
...
remained the same, we recommend reading the @ref[Serialization](serialization.md#serialization-scala) documentation first.
...
as usual (which is explained in @ref[Serialization](serialization.md#serialization-scala)).
...
remote messages. Please refer to the @ref[Serialization](serialization.md#serialization-scala) documentation as well as [ByteBuffer based serialization](#remote-bytebuffer-serialization-scala) to learn how to do this.

## Routers with Remote Destinations

It is absolutely feasible to combine remoting with @ref[Routing](routing.md#routing-scala).
