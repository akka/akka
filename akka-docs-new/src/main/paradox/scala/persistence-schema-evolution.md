<a id="persistence-schema-evolution-scala"></a>
# Persistence - Schema Evolution

When working on long running projects using @ref[Persistence](persistence.md#persistence-scala), or any kind of [Event Sourcing](http://martinfowler.com/eaaDev/EventSourcing.html) architectures,
...
type to `PersistentActor` s and @ref[persistence queries](persistence-query.md#persistence-query-scala). This allows the business logic layer to focus on solving business problems
...
Akka Persistence provides [Google Protocol Buffers](https://developers.google.com/protocol-buffers/) based serializers (using @ref[Akka Serialization](serialization.md#serialization-scala))
...
This section aims to highlight the complete basics on how to define custom serializers using @ref[Akka Serialization](serialization.md#serialization-scala).
...
> **Note:**
Read the @ref[Akka Serialization](serialization.md#serialization-scala) docs to learn more about defining custom serializers,
...
Please refer to the @ref[Akka Serialization](serialization.md#serialization-scala) documentation for more advanced use of serializers,
...
@@snip [PersistenceSchemaEvolutionDocSpec.scala](code/docs/persistence/PersistenceSchemaEvolutionDocSpec.scala) { #rename-plain-json }
...
using @ref[Persistence Query](persistence-query.md#persistence-query-scala) would not be an efficient way to go about this, without compromising the
