...
carrying @ref[log messages](logging.md#logging-scala) and [Dead Letters](#dead-letters) and may be
...
If you need to broadcast events in an Akka cluster, *without* knowing your recipients explicitly (i.e. obtaining their ActorRefs), you may want to look into: @ref[Distributed Publish Subscribe in Cluster](distributed-pub-sub.md#distributed-pub-sub-scala).
