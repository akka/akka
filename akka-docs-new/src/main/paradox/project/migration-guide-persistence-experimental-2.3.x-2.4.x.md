...
Read more about the persistent actor in the @ref[documentation for Scala](../scala/persistence.md#event-sourcing-scala) and
@ref[documentation for Java](../java/persistence.md#event-sourcing-java).
...
A longer discussion on this subject can be found on [issue #15436 ](https://github.com/akka/akka/issues/15436) on github.
...
Read more about at-least-once delivery in the @ref[documentation for Scala](../scala/persistence.md#at-least-once-delivery-scala) and
@ref[documentation for Java](../java/persistence.md#at-least-once-delivery-java).  
