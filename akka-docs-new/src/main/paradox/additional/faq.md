...
its @ref[full path](../general/addressing.md#addressing), which is of the form:
...
Read more in @ref[Message Delivery Reliability](../general/message-delivery-reliability.md#message-delivery-reliability).
...
Read more about it in the docs for @ref[Logging](../java/logging.md#logging-java) and @ref[actor.logging-scala](../scala/testing.md#actor-logging-scala).