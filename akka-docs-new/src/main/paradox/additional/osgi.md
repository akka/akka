...
@@snip [Activator.scala](code/docs/osgi/Activator.scala) { #Activator }
...
A complete sample project is provided in [akka-sample-osgi-dining-hakkers](@github@/akka-samples/akka-sample-osgi-dining-hakkers)