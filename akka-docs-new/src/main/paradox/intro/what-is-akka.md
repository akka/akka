...
See the chapter for @ref[Scala](../scala/actors.md#actors-scala) or @ref[Java](../java/untyped-actors.md#untyped-actors-java).
...
See @ref[Fault Tolerance (Scala)](../scala/fault-tolerance.md#fault-tolerance-scala) and @ref[Fault Tolerance (Java)](../java/fault-tolerance.md#fault-tolerance-java).
...
For an overview of the cluster support see the @ref[Java](../java/cluster-usage.md#cluster-usage-java)
and @ref[Scala](../scala/cluster-usage.md#cluster-usage-scala) documentation chapters.
...
You can find more details in the respective chapter for @ref[Java](../java/persistence.md#persistence-java) or @ref[Scala](../scala/persistence.md#persistence-scala).

## Scala and Java APIs

Akka has both a @ref[Scala Documentation](../scala.md#scala-api) and a @ref[Java Documentation](../java.md#java-api).
...
](http://www.lightbend.com/how/subscription).