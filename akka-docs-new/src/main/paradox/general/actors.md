...
The previous section about @ref[Actor Systems](actor-systems.md#actor-systems) explained how actors form
...
@ref[Actors (Scala)](../scala/actors.md#actors-scala) and @ref[Untyped Actors (Java)](../java/untyped-actors.md#untyped-actors-java).
...
the @ref[FSM](../scala/fsm.md#fsm-scala) module), or it could be a counter, set of listeners,
...
restart (see @ref[Persistence](../scala/persistence.md#persistence-scala)).
...
of the strategies described in @ref[Supervision and Monitoring](supervision.md#supervision) for each incoming failure.
