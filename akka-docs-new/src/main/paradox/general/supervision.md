...
As described in @ref[Actor Systems](actor-systems.md#actor-systems) supervision describes a dependency
...
when a @ref[PersistentActor](../scala/persistence.md#persistence-scala) fails (by stopping) with a persistence failure - which indicates that
...
@@snip [BackoffSupervisorDocTest.java](../java/code/docs/pattern/BackoffSupervisorDocTest.java) { #backoff-imports }

@@snip [BackoffSupervisorDocTest.java](../java/code/docs/pattern/BackoffSupervisorDocTest.java) { #backoff-stop }
...
@@snip [BackoffSupervisorDocTest.java](../java/code/docs/pattern/BackoffSupervisorDocTest.java) { #backoff-fail }
...
@ref[Routing](../scala/routing.md#routing-scala) or @ref[Routing](../java/routing.md#routing-java).