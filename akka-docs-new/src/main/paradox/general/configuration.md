...
](https://github.com/typesafehub/config), which might also be a good choice
...
HOCON specification
](https://github.com/typesafehub/config/blob/master/HOCON.md) (near the
...
](http://maven.apache.org/plugins/maven-shade-plugin) support for [Resource
Transformers
