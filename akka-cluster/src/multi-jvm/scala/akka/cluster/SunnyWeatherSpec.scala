...
class SunnyWeatherArteryMultiJvmNode1 extends SunnyWeatherRemotingSpec
class SunnyWeatherArteryMultiJvmNode2 extends SunnyWeatherRemotingSpec
class SunnyWeatherArteryMultiJvmNode3 extends SunnyWeatherRemotingSpec
class SunnyWeatherArteryMultiJvmNode4 extends SunnyWeatherRemotingSpec
class SunnyWeatherArteryMultiJvmNode5 extends SunnyWeatherRemotingSpec
