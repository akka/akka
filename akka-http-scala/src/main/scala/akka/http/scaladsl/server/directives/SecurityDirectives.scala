...
trait SecurityDirectives {
  ...
  type Authenticator[T] = UserCredentials ⇒ Future[Option[T]]
  type StrictAuthenticator[T] = UserCredentials ⇒ Option[T]
  type AuthenticatorPF[T] = PartialFunction[UserCredentials, Future[T]]
  type StrictAuthenticatorPF[T] = PartialFunction[UserCredentials, T]
