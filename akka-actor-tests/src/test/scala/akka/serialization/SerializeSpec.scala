...
class SerializationCompatibilitySpec extends AkkaSpec(SerializationTests.mostlyReferenceSystem) {
  ...
  "Cross-version serialization compatibility" must {
    ...
    "be preserved for the Create SystemMessage" ignore { //FIXME changed in Scala 2.11
    ...
    "be preserved for the Recreate SystemMessage" ignore { //FIXME changed in Scala 2.11
    ...
    "be preserved for the Suspend SystemMessage" ignore { //FIXME changed in Scala 2.11
      verify(Suspend(),
        "aced00057372001c616b6b612e64697370617463682e7379736d73672e53757370656e6400000000" +
          "000000010200007870")
    }
    "be preserved for the Resume SystemMessage" ignore { //FIXME changed in Scala 2.11
      verify(Resume(null),
    ...
    "be preserved for the Terminate SystemMessage" ignore { //FIXME changed in Scala 2.11
      verify(Terminate(),
        "aced00057372001e616b6b612e64697370617463682e7379736d73672e5465726d696e6174650000" +
          "0000000000010200007870")
    }
    "be preserved for the Supervise SystemMessage" ignore { //FIXME changed in Scala 2.11
    ...
    "be preserved for the Watch SystemMessage" ignore { //FIXME changed in Scala 2.11
    ...
    "be preserved for the Unwatch SystemMessage" ignore { //FIXME changed in Scala 2.11
    ...
    "be preserved for the NoMessage SystemMessage" ignore { //FIXME changed in Scala 2.11
      verify(NoMessage,
        "aced00057372001f616b6b612e64697370617463682e7379736d73672e4e6f4d6573736167652400" +
          "000000000000010200007870")
    }
    "be preserved for the Failed SystemMessage" ignore { //FIXME changed in Scala 2.11
      // Using null as the cause to avoid a large serialized message and JDK differences
